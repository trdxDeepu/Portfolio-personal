...
function Project ({
  ...
  return (
    ...
    >
      ...
      >
        <div
          className='px-5 pb-7 pt-4 sm:pl-10 sm:pr-2  sm:pt-10 sm:max-w-[50%] flex flex-col h-full
        group-even:ml-[18rem] 
        '
        >
        ...
        <Image
          src={imageUrl}
          alt={`${title} Project i Built`}
          quality={95}
          className='absolute top-8 -right-40 w-[28.25rem] rounded-t-lg shadow-2xl
        group-even:right-[initial] group-even:-left-40 transition group-hover:scale-[1.04] group-hover:-translate-x-3 group-hover:translate-y-3 
